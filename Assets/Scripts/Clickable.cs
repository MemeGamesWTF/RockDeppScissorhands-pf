...
public class Clickable : MonoBehaviour
{
    ...
    public void SfxToggle(bool value)
    {
        ...
        {
            audioSource.PlayOneShot(lostpoint);
        }
    }
    ...
    private void OnMouseDown()
    {
        ...
        if (GamesPlayedInt < 10)
        {
            if (tag.Equals("ChooseRockL"))
            {
                ...
                Instantiate(Rock, new Vector3(-10f, -1f, 7.2f), transform.rotation);
                choice = 1;
                CompMove();
            }
            if (tag.Equals("ChoosePaperL"))
            {
                ...
                Instantiate(Paper, new Vector3(-10f, -1f, 7.2f), transform.rotation);
                choice = 2;
                CompMove();
            }
            if (tag.Equals("ChooseScissorsL"))
            {
                ...
                Instantiate(Scissors, new Vector3(-10f, -1f, 7.2f), transform.rotation);
                choice = 3;
                CompMove();
            }
    ...
    void CompMove()
    {
        ...
        if (r == 1) Instantiate(ERock, new Vector3(10f, -1f, 7.2f), transform.rotation);
        else if (r == 2) Instantiate(EPaper, new Vector3(10f, -1f, 7.2f), transform.rotation);
        else if (r == 3) Instantiate(EScissors, new Vector3(10f, -1f, 7.2f), transform.rotation);
    ...
    void displayEndScreen()
    {
        ...
        if (score > Escore) { PWINS.SetActive(true); audioSource.PlayOneShot(win); }
        else if (score < Escore) { CWINS.SetActive(true); audioSource.PlayOneShot(lost); }
        else if (score == Escore) { TIE.SetActive(true);audioSource.PlayOneShot(lost); }
    }
